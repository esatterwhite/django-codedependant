...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('publisher_article', 'summary', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.summary'
        db.delete_column('publisher_article', 'summary')
    ...
    models = {
        ...
        'hotsauce.changeset': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 23, 8, 33, 34, 989000)'}),
