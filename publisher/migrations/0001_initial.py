...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('publisher_article', (
            ...
            ('initial_publish', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('publisher', ['Article'])


    def backwards(self, orm):
        
        # Deleting model 'Article'
        db.delete_table('publisher_article')
    ...
    models = {
        ...
        'hotsauce.changeset': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 23, 8, 27, 26, 489000)'}),
